...
-- Criação da tabela 'Movimento' para registrar transações
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
-- Criação da tabela 'PessoaFisica' para informações específicas de pessoas físicas
CREATE TABLE PessoaFisica (
  idPessoa INT NOT NULL PRIMARY KEY,  -- ID da pessoa
  cpf VARCHAR(11) NULL,               
  FOREIGN KEY (idPessoa) REFERENCES Pessoa(idPessoa)  -- Chave estrangeira para a tabela 'Pessoa'
);
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
-- Criação da tabela 'Pessoa' para informações gerais de pessoas
CREATE TABLE Pessoa (
  idPessoa INTEGER IDENTITY(1,1) NOT NULL PRIMARY KEY,  -- ID único da pessoa
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
-- Criação da tabela 'PessoaJuridica' para informações específicas de pessoas jurídicas
CREATE TABLE PessoaJuridica (
    idPessoa INT NOT NULL PRIMARY KEY,  -- ID da pessoa jurídica
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
-- Criação da tabela 'Produto' para informações sobre produtos
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
-- Criação da tabela 'Usuario' para informações de usuários

...
public class PessoaFisicaDAO {
    ...
    // Construtor que recebe o ConectorBD como parâmetro
    ...
    public void incluir(PessoaFisica pessoa) {
        ...
        try {
            connection = ConectorBD.getConnection();
            // Ativa o IDENTITY_INSERT para a tabela "Pessoa" para permitir a inserção do valor explícito na coluna de identidade.
    ...
    // Altera os dados de uma pessoa física no banco de dados
    ...
    // Exclui uma pessoa física do banco de dados
